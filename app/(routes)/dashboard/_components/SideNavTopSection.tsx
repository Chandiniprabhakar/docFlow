        ...
        <Popover>
            ...
            <PopoverContent className='ml-7 p-4'>
                <div>
                    {teamList?.map((team, index)=>(
                        ...
                        className={`p-2 rounded-lg mb-1 cursor-pointer 
                            hover:bg-[#1150ab] hover:text-white 
                            ${activeTeam?._id === team._id ? 'bg-[#1150ab] text-white' : 'bg-white text-black'}`}
                        >
                        {team.teamName}
                        </h2>
                ...
                {menu.map((item, index) => (
                    <h2
                    key={index}
                    className="flex gap-2 items-center p-2 hover:bg-gray-100 rounded-lg text-sm"
